...
\addcontentsline{toc}{subsection}{Exercício 2}

\subsubsection*{\textbf{ID3:}}
\addcontentsline{toc}{subsubsection}{ID3}
    \begin{itemize}
...
\addcontentsline{toc}{subsubsection}{J48 - Unpruned}
    \begin{itemize}
        \item Tempo de construção: \textbf{0 segundos.}
        \item Características:
        \begin{itemize}
...
\addcontentsline{toc}{paragraph}{Exemplo padrão}
...
\addcontentsline{toc}{paragraph}{Exemplo modificado 1}
...
\addcontentsline{toc}{paragraph}{Exemplo modificado 2}
